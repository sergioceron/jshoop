			...
			<table style="margin: 15px 0pt 0pt;" border="0" cellpadding="0"
				...
				<tbody>
					<tr>
						...
						<td><input name="userName" size="18" type="text"> <?php if( strpos( $fields, 'userName' ) ){?><br>
					...
					<tr>
						...
						<td><input name="userPassword" size="18" type="password"> <?php if( strpos( $fields, 'userPassword' ) ){?><br>
						<span class="errormsg" id="errormsg_0"> <?=$_i18n[ "error.required" ]?>
						</span><?php } ?></td>
					</tr>
					<tr>
