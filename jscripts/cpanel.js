...
function execResponse( page, idx ){
	...
	Ajax.onload = function( object ){
		...
		document.getElementById('status' ).innerHTML=texto[0];
		document.getElementById('count').innerHTML=texto[1];
		document.getElementById('count2').innerHTML=texto[2];
		document.getElementById('sub').innerHTML=texto[3];
		document.getElementById('iva').innerHTML=texto[4];
		document.getElementById('total').innerHTML=texto[5];
		closeMessage();
	}
