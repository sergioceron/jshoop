...
$selected = $_GET[ "sm" ];$sselected = 1; $subtitle = $selected==0?$_i18n["index.submenu1"]:$_i18n["index.submenu2"];
$items = array( $_i18n["index.submenu1"], $_i18n["index.submenu2"] ); $links = array( "?sm=0", "?sm=1" );
...
foreach( $categories as $cat ){
	...
	<span class="beta"><?=$_i18n["new"]?></span> <span> - <?=$products ?> <?=$_i18n["product"]?></span>
