...
$sselected = 1; $subtitle = $_i18n["register.submenu"]; $selected = 1;
...
<table>
	...
	<tr>
		...
		<td><span class="errorbox-good"><textarea name="address" rows="6"
			cols="40" id="supportcontact"></textarea> </span> <?php if( strpos( $fields, 'address' ) ){?><br>
		<span class="errormsg" id="errormsg_0"> <?=$_i18n["emptyfield"]?> </span><?php } ?></td>
	</tr>
	<tr>
		<th><?=$_i18n["phone"]?>:</th>
		<td><span class="errorbox-good"> <input type="text" name="phone"
			value="" id="" size="30"> </span> <?php if( strpos( $fields, 'phone' ) ){?><br>
		<span class="errormsg" id="errormsg_0"> <?=$_i18n["emptyfield"]?> </span><?php } ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><span class="errorbox-good"> <input type="text" value=""
			name="credit" value="" id="" size="30"> </span> <?php if( strpos( $fields, 'credit' ) ){?><br>
		<span class="errormsg" id="errormsg_0"> <?=$_i18n["emptyfield"]?> </span><?php } ?></td>
	</tr>
	<tr>
		<th><?=$_i18n["type"]?>:</th>
