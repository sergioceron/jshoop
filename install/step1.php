...
<head>
    <title>jShoop &rsaquo; Configuraci�n</title>
...
<form method="post" action="update.php">
    <p>A continuaci�n se le pedir� informaci�n sobre su base de datos. Si no conoce alg�n parametro consulte a su
        administrador. </p>
    <table class="form-table">
        ...
        <tr>
            <th scope="row"><label for="pwd">Contrase�a</label></th>
            <td><input name="pwd" id="pwd" type="password" size="21" value="root"/></td>
            <td>...y la contrase�a del usuario.</td>
        </tr>
        <tr>
