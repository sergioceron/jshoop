...
$sselected = 2;
$subtitle = $_i18n["categories.submenu"];
        ...
        <table>
            ...
            <tr class="">
                ...
                <td style="width: 34.5%;"><a href="javascript:void(0)"
                                             onclick="displayArticle( 'product.php?id=<?=base64_encode($productos[$i]->articulo_id)?>' );return false"><?=$productos[$i]->articulo_nombre?></a>
                </td>
