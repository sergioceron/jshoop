...
$validator->setMethod("POST");
$validator->setVars(array("pass_now:required", "pass:required"));

if ($validator->validate() && $login == 1) {
    ...
    for ($err = "", $i = 0; $i < count($e = $validator->getErrors()); $i++) {
        $err = $err . ";" . $e[$i]["field"];
    }
