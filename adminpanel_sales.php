...
$sselected = 3;
$subtitle = $p == 1 ? $_i18n["admin.onhold"] : $_i18n["admin.salesp"];
$selected = 1;
    ...
    <table>
        ...
        <tr class="" id="ARTICLE_COLLECTION_SELECTION_<?=$i?>">
            ...
            <td><a href="javascript:void(0)"
                   onclick="go( 'adminpanel_sale.php?cid=<?=base64_encode($productos[$i]->compra_numero)?>&pid=<?=base64_encode($p)?>' );return false"><?=$username?></a>
            </td>
