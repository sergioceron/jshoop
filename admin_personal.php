...
$sselected = 4;
$subtitle = $_i18n["personal.submenu"];
        ...
        <table>
            <tr>
                ...
                <td><span class="errorbox-good"> <input type="text"
                                                        value="<?=$user->usuario_nombre?>" name="user_name" id="fn"
                                                        size="30">
            ...
            <tr>
                ...
                <td><span class="errorbox-good"> <input type="text"
                                                        value="<?=$user->usuario_apellidos?>" name="user_lastname"
                                                        id="fn"
                                                        size="30"> </span> <?php if (strpos($fields, 'user_lastname')) { ?>
                    <br>
            ...
            <tr>
                ...
                <td><span class="errorbox-good"> <input type="checkbox"
                    <?=($user->usuario_compartido == "1" ? "checked=\"checked\"" : "")?>
                                                        name="shared" id="fn" size="30"><?=$_i18n["info2"]?> </span>
                </td>
            </tr>
            <tr>
                <th><?=$_i18n["born"]?>:</th>
                <td><span class="errorbox-good"> <input type="text"
                                                        ...
                                                        id="user_born" size="30"> <input type="button"
                                                                                         value="Calendario"
            ...
            <tr>
                ...
                <td><span class="errorbox-good"> <textarea name="user_address"
                                                           rows="6" cols="40"
                                                           id="supportcontact"><?=$user->usuario_direccion?></textarea>
            ...
            <tr>
                ...
                <td><span class="errorbox-good"> <input type="text" name="user_phone"
                                                        value="<?=$user->usuario_telefono?>" id="fn"
                                                        size="30"> </span> <?php if (strpos($fields, 'user_phone')) { ?>
                    <br>
                    <span class="errormsg" id="errormsg_0"> <?=$_i18n["emptyfield"]?> </span><?php } ?></td>
            </tr>
            <tr>
                ...
                <td><span class="errorbox-good"> <input type="text" name="user_mail"
                                                        value="<?=$user->usuario_correo?>" id="fn"
                                                        size="30"> </span> <?php if (strpos($fields, 'user_mail')) { ?>
                    <br>
                    <span class="errormsg" id="errormsg_0"> <?=$_i18n["emptyfield"]?> </span><?php } ?></td>
            </tr>
            <tr class="finalrow">
